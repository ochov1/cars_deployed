...
vehicles.route("/page/:page/:carsPerPage").get(_vehiclesController["default"].getVehicles);
vehicles.route("/page/:page/filters").get(_vehiclesController["default"].getVehicles);
vehicles.route("/filter").get(_vehiclesController["default"].vehiclesFilters);
